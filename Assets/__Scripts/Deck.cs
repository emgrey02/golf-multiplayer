...
[Header("Set in Inspector")]
	...
	public void InitDeck(string deckXMLText) {
		...
		deckAnchor = GameObject.Find("Deck").transform;
	...
	public void MakeCards() {
		...
		for (int i = 0; i < cardNames.Count; i++) {
			GameObject cgo = PhotonNetwork.Instantiate("PrefabCardGolf", new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
			cgo.transform.parent = deckAnchor;
			Card card = cgo.GetComponent<Card>();
			
			cgo.transform.localPosition = new Vector3(0, 0, 0);
			...
			foreach (Decorator deco in decorators) {
				tGO = PhotonNetwork.Instantiate("PrefabSprite", new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
